...
CREATE TABLE `customer_order` (
                                  ...
                                  `amount` DECIMAL(10,2) NOT NULL,  -- Fixed: Changed from INT to DECIMAL
...
CREATE TABLE `book` (
                        ...
                        `description` TEXT NOT NULL,  -- Fixed: Changed from VARCHAR(1000) to TEXT
                        `price` DECIMAL(10,2) NOT NULL,  -- Fixed: Changed from INT to DECIMAL
