...
public class BookDaoJdbc implements BookDao {
    ...
    public Book findByBookId(long bookId) {
        ...
        try (Connection connection = JdbcUtils.getConnection();
            ...
            throw new BookstoreDbException.BookstoreQueryDbException("Encountered a problem finding book " + bookId, e);
        }
        return book;
    }
    ...
    public List<Book> findByCategoryId(long categoryId) {
        ...
        try (Connection connection = JdbcUtils.getConnection();
            ...
            throw new BookstoreDbException.BookstoreQueryDbException(
                    "Encountered a problem finding books by category ID: " + categoryId, e);
        }
        return books;
    }
    ...
    public List<Book> findRandomByCategoryId(long categoryId, int limit) {
        ...
        try (Connection connection = JdbcUtils.getConnection();
            ...
            throw new BookstoreDbException.BookstoreQueryDbException(
                    "Encountered a problem finding random books by category ID: " + categoryId, e);
        }
        return books;
    }
